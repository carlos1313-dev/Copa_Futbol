package com.pes.copa.tournaments.config;
...
public class WebClientConfig {
    ...
    @Value("${services.matches.url:http://localhost:8083}")
    ...
    /**
     * WebClient para Matches Service
     * @return cliente configurado para Matches Service
     */
    @Bean
    public WebClient matchesWebClient() {
        return createWebClient(matchesServiceUrl);
    }
